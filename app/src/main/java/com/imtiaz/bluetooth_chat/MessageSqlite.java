package com.imtiaz.bluetooth_chat;
...
public class MessageSqlite extends SQLiteOpenHelper {
    ...
    public MessageSqlite(Context context) {
        ...
        //the query for creating the Messages DATABASE for the first time
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        //the query for creating the Messages TABLE
    ...
    public ArrayList<cMessage> getMessages(String adresse) {

        // get Messages concerning a specific address
